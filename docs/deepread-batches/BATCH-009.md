# Deep-read editorial batch BATCH-009
...
1. `xing-qi-yi-tian-qi-qing-wo-li-kai-ni` — 星期一天气晴我离开你 (favorite=low, was scaffold)
2. `xu-yao-ni` — 需要你 (favorite=low, was scaffold)
3. `xuan-wo` — 漩涡 (favorite=low, was scaffold)
4. `xue-hui` — 学会 (favorite=low, was scaffold)
5. `yan-shen` — 眼神 (favorite=low, was scaffold)
6. `yang-zi` — 样子 (favorite=low, was scaffold)
