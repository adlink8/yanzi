      ...
      <section className="grid gap-6 md:grid-cols-2">
        <div className="card space-y-3">
          ...
          {featured.map((song) => {
            ...
            return (
              <Link key={song.slug} href={songHref} className="block rounded-xl border border-line p-4 no-underline hover:bg-paper">
        ...
        <div className="card space-y-3">
          <h2 className="text-xl font-semibold">当前阶段</h2>
