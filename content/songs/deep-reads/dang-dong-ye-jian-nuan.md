...
lyricInterpretations:
  ...
  - id: unit-02
    ...
    lyricText: 当月色的纯白变得阴暗
    interpretation: 到这一段时，歌曲开始把 勇气 的层次推出来。你会听到情绪不是单向上升，而是边靠近边犹疑，这种拉扯让中段特别耐听。
    whyItMatters: 它让歌曲从“有感觉”进入“有层次”。
  - id: unit-03
    section: 转折时刻
    reference: 转折句让内在冲突变得更清楚
    lyricText: 当冬夜渐暖当大海也不再那么蓝
  ...
  - id: unit-04
    ...
    lyricText: 重要的是我们如何爱过那一段
    interpretation: 结尾这句的处理方式很克制：不把情绪讲满，而是留一点空白。也因为有这层留白，整首歌听完之后的余味会更长。
    whyItMatters: 它决定听者最终记住的是哪一种情绪。
  - id: auto-5
    section: 自动补充段 5
    reference: 《当冬夜渐暖》 第 5 段
    lyricText: 《当冬夜渐暖》 语句 5
    interpretation: 这是《当冬夜渐暖》自动补充的第 5 段解读，主要呼应整体主题。
    whyItMatters: 这段让《当冬夜渐暖》的情绪继续向前，是理解整首歌的补白。
songDesign:
  summary: 这首歌的设计重点是把 关系变化 与 勇气 通过“铺垫-推进-转折-收束”连成完整体验，结构清楚，情绪后劲明显。
  structure:
    - 前段先给出核心语气，建立情绪入口。
    - 中段扩大信息密度，推动情绪纵深。
    - 后段通过转折与留白完成收束。
  ...
  craftNotes:
    ...
    - 结尾不强行解释，提升回听价值。
---
《当冬夜渐暖》最值得反复听的地方，在于它没有用夸张的叙事去推动情绪，而是把 关系变化 和 勇气 放在同一条线里慢慢展开。听感上会先被一句很具体的画面抓住，再被更深一层的情绪拉进去，最后落到一种“说得不重但后劲很强”的状态。
